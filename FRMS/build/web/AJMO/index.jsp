<%-- 
    Document   : index
    Created on : Nov 28, 2018, 7:45:56 PM
    Author     : TOSHIBA
--%>
    ...
    <div style="margin-top:29px;">
        <div class="container">
            <div class="row" style="margin-top:60px;">
                <div class="col align-content-center" style="height:180px;text-align:center;/*box-sizing:border-box;*//*display:block;*/margin-right:3rem;margin-left:2rem;padding:5%;padding-right:0;padding-left:0;"><button class="btn btn-primary onebtn" type="button" >Create MLEF</button></div>
                <div class="col" style="margin-right:3rem;margin-left:3rem;padding:5%;padding-right:0;padding-left:0;"><button class="btn btn-primary onebtn" type="button" >Create PM</button></div>
                <div class="col" style="margin-right:3rem;margin-left:3rem;padding:5%;padding-right:0;padding-left:0;"><button class="btn btn-primary onebtn" type="button" >Create MLR</button></div>
            </div>
        </div>
    </div>
