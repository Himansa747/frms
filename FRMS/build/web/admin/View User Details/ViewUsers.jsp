                ...
                <table  id="cnLeftTable">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4" style="border-style:groove;"><br>
                            <a href="View_JMO.jsp"><img src="Images/User.png" width="200px" height="200px" class="img-rounded">
                                <h4 style="color: #ffe6e6;">Judicial Medical<br>Officer</h4></a>
                        </div>
                        
                        <div class="col-md-4" style="border-style:groove;"><br>
                            <a href="View_police.jsp"><img src="Images/police.png" width="200px" height="200px" class="img-rounded">
                                <h4 style="color: #ffe6e6;">Hopital Police<br>Officer</h4></a>
                        </div>
                        
                        <div class="col-md-4" style="border-style:groove"><br>
                            <a href="View_Reigistrar.jsp"><img src="Images/registrar.png" width="200px" height="200px" class="img-rounded">
