    ...
    <body onload="startTime()">
        ...
        <form action="../add_police" method="POST">
                ...
                <table cellspecing="500" cellpadding="20" align="center">
                    ...
                    <tr>
                        <td>Name</td>
                        <td><input placeholder="Name" type="text" name="name1" tabindex="2" required autofocus></td>
                    </tr>
                    ...
                    <tr>
                        <td>Password</td>
                        <td><input placeholder="Enter Password" type="password" name="password1" tabindex="2" required autofocus></td>
                    </tr>
                    <tr>
                        <td>Re-Password</td>
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td><input placeholder="Police station" type="text" name="station" tabindex="2" required autofocus></td>
                    </tr>

                    <tr>
                        <td>Type</td>
                        <td><input type="text" name="ptype" value="HPLO" readonly></td>
                    </tr>
